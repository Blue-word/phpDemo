<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"./application/admin/view/news/rotation_imgList.html";i:1497258622;s:43:"./application/admin/view/public/layout.html";i:1499577478;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div class="flexigrid">
    <div class="mDiv">
	  ...
	  <form class="navbar-form form-inline" action="<?php echo U('Admin/News/totation_imgList'); ?>" method="post">      
      <div class="sDiv">
        <div class="sDiv2">
          <select  name="cat_id" class="select">
            <option value="">选择轮播图类别</option>
          ...
          <thead>
            <tr>
              ...
              <th align="left" abbr="ac_id" axis="col4" class="">
                <div style="text-align: left; width: 150px;" class="">轮播图分类</div>
              </th>
    ...
    <div class="tDiv">
      <div class="tDiv2">
        <div class="fbutton"> <a href="<?php echo U('Admin/News/rotation_imgAdd'); ?>">
