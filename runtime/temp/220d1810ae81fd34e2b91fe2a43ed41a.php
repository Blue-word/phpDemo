<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./application/admin/view/admin\role.html";i:1500885882;s:43:"./application/admin/view/public\layout.html";i:1499577477;}*/ ?>
<!doctype html>
<html>
<head>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): if($vo['role_id'] > 1): ?>
							<tr>
								...
								<td align="center" class="">
									<div style="text-align: center; width: 150px;"><?php echo $vo['role_name']; ?></div>
								</td>
								<td align="center" class="">
									<div style="text-align: center; width: 150px;"><?php echo $vo['role_desc']; ?></div>
								</td>
