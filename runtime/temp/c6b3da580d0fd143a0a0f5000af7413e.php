<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view/life\carService.html";i:1500432020;s:43:"./application/admin/view/public\layout.html";i:1499577477;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div class="flexigrid">
    ...
    <form class="navbar-form form-inline" action="<?php echo U('Admin/Life/carService'); ?>" method="post">      
      <div class="sDiv">
        <div class="sDiv2">
