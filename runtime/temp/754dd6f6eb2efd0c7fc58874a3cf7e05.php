<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view/system\right_list.html";i:1500885927;s:43:"./application/admin/view/public\layout.html";i:1499577477;}*/ ?>
<!doctype html>
<html>
<head>
				...
				<table cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<th align="center" abbr="ac_id" axis="col4" class="">
							<div style="text-align: center; width: 100px;" class="">资源类型</div>
						</th>
					...
					<?php if(is_array($right_list) || $right_list instanceof \think\Collection || $right_list instanceof \think\Paginator): if( count($right_list)==0 ) : echo "" ;else: foreach($right_list as $k=>$vo): ?>
						<tr>
							...
							<td align="center" class="">
								<div style="text-align: center; width: 100px;"><?php if($vo['type'] == 1): ?>商家后台 <?php else: ?> 系统后台<?php endif; ?></div>
							</td>
							<td align="center" class="">
								<div style="text-align: center; width: 100px;"><?php echo $group[$vo[group]]; ?></div>
							</td>
							<td align="center" class="">
								<div style="text-align: center; width: 500px;"><?php echo $vo['right']; ?></div>
							</td>
