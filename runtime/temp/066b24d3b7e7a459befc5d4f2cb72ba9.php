<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view/system\shop_info.html";i:1499653949;s:43:"./application/admin/view/public\layout.html";i:1499577477;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a href="<?php echo U('System/index'); ?>" class="current"><span>新闻版块</span></a></li>
    ...
    <form method="post" id="handlepost" action="<?php echo U('System/handle'); ?>" enctype="multipart/form-data" name="form1">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <textarea rows="3" cols="180" name="original_statement" class="input-txt" placeholder="本文系本站原创采写，欢迎转载！转载时必须在醒目位置注明本文出处和具体网页链接。对注明而擅自转载者，本站保留追究法律责任的权利。如有问题可联络lyq1052446882@sina.com。"><?php echo $news['original_statement']; ?></textarea>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <textarea rows="3" cols="180" name="reproduit_statement" class="input-txt" placeholder="本文为转载发布，仅代表原作者或平台态度，不代表我方观点。小蚂蚁仅提供信息发布平台，文章有适当删改。对转载有异议和删稿要求的原著方，可联络lyq1052446882@sina.com。"><?php echo $news['reproduit_statement']; ?></textarea>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <span class="err">如:娱乐|社会|交友</span>
                    <p class="notic">首页搜索界面显示的热门关键词，导航查询</p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label for="point_rate">搜索词所属类别</label>
                </dt>
                <dd class="opt">
                    <input type="radio" id="point_rate" name="point_rate" value="1"  <?php if($config[point_rate] == 1): ?> checked <?php endif; ?> > 新 闻  &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="point_rate" value="10" <?php if($config[point_rate] == 10): ?> checked <?php endif; ?> > 论 坛  &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="point_rate" value="100"<?php if($config[point_rate] == 100): ?> checked <?php endif; ?> > 我 的
