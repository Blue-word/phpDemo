<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:35:"./application/admin/view/ad/ad.html";i:1502351360;s:43:"./application/admin/view/public/layout.html";i:1499577478;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="ncap-form-default tab_div_1">
            ...
            <dl class="row" data-name="news">
             ...
             <dl class="row">
                ...
                <dd class="opt">
                    <select class="small form-control"  style="width:200px"  tabindex="1" name="position">
