<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view/forum/carService.html";i:1502159360;s:43:"./application/admin/view/public/layout.html";i:1499577478;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div class="flexigrid">
    ...
    <form class="navbar-form form-inline" action="<?php echo U('Admin/Forum/carService'); ?>" method="post">      
      <div class="sDiv">
        <div class="sDiv2">
        ...
        <table cellspacing="0" cellpadding="0">
          <thead>
            <tr>
              ...
              <th align="center">
                <div style="text-align: center; width: 80px;">服务类型</div>
              </th>
              <th align="center">
                <div style="text-align: center; width: 140px;">公司名称</div>
              </th>
              <th align="center">
                <div style="text-align: center; width: 120px;">发布时间</div>
              </th>
              <th align="center">
          ...
          <tbody>
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
              <tr>
                ...
                <td align="center">
                  <div style="text-align: center; width: 80px;"><?php echo $vo['area']; ?></div>
                </td>
                <td align="center">
                  <div style="text-align: center; width: 80px;"><?php echo $vo['service_type']; ?></div>
                </td>
                <td align="center">
                  <div style="text-align: center; width: 140px;"><?php echo $vo['company_name']; ?></div>
                </td>
                <td align="center">
                ...
                <td align="center" class="handle">
                  ...
                  <a class="btn blue"  href="<?php echo U('Forum/carServiceDet',array('act'=>'detail','id'=>$vo['id'])); ?>"><i class="fa fa-search"></i>审核</a>
                  <a class="btn red"  href="javascript:void(0)" data-url="<?php echo U('Forum/carHandel'); ?>" data-id="<?php echo $vo['id']; ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
                  </div>
                </td>
