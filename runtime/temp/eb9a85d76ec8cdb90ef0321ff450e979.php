<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view/life\secondMarket.html";i:1500433270;s:43:"./application/admin/view/public\layout.html";i:1499577477;}*/ ?>
<!doctype html>
<html>
<head>
          ...
          <tbody>
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
              <tr>
                ...
                <td align="center">
                  <div style="text-align: center; width: 120px;"><?php echo $vo['product_cate']; ?></div>
                </td>
                <td align="center">
                  <div style="text-align: center; width: 60px;"><?php echo $vo['source']; ?></div>
                </td>
                <td align="center">
                  <div style="text-align: center; width: 60px;"><?php echo $vo['education']; ?></div>
                </td>
                <td align="center">
                  <div style="text-align: center; width: 60px;"><?php echo $vo['price']; ?></div>
                </td>
                <td align="center">
                  <?php if($vo['type'] == '求职'): ?>
