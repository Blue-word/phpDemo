<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:39:"./application/admin/view/admin\log.html";i:1500882328;s:43:"./application/admin/view/public\layout.html";i:1499577477;}*/ ?>
<!doctype html>
<html>
<head>
			...
			<div class="hDivBox">
				<table cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<th align="center">
							<div style="text-align: center; width: 150px;" class="">角色名称</div>
						</th>
						<th align="center">
							<div style="text-align: center; width: 150px;" class="">描述</div>
						</th>
						<th align="center">
							<div style="text-align: center; width: 150px;" class="">IP</div>
						</th>
						<th align="center">
							<div style="text-align: center; width: 200px;" class="">操作时间</div>
						</th>
				...
				<table>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
						<tr>
							...
							<td align="center">
								<div style="text-align: center; width: 150px;"><?php echo $vo['log_id']; ?></div>
							</td>
							<td align="center">
								<div style="text-align: center; width: 150px;"><?php echo $vo['user_name']; ?></div>
							</td>
							<td align="center">
								<div style="text-align: center; width: 150px;"><?php echo $vo['log_info']; ?></div>
							</td>
							<td align="center">
								<div style="text-align: center; width: 150px;"><?php echo $vo['log_ip']; ?></div>
							</td>
							<td align="center">
								<div style="text-align: center; width: 200px;"><?php echo date("Y-m-d H:i:s",$vo['log_time']); ?></div>
							</td>
