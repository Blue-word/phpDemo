<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view/news\getNews.html";i:1501551108;s:43:"./application/admin/view/public\layout.html";i:1499577477;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><!-- <a class="back" href="javascript:history.back();" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a> -->
      <div class="subject">
        <h3>获取新闻</h3>
        <h5>获取澳洲新闻、国际、国内等热门实时新闻</h5>
      </div>
    </div>
  </div>
	<form action="<?php echo U('News/getNewsList'); ?>" method="post" class="form-horizontal">
    <div class="ncap-form-default">
            <dl class="row" data-name="news">
                <dt class="tit">
                  <label for="ac_name"><em>*</em>新闻来源选择</label>
                </dt>
                <dd class="opt">
                    <div class="onoff">
                        <label for="article_show1" class="cb-enable <?php if($news[url] == 1): ?>selected<?php endif; ?>">国际国内新闻</label>
                        <label for="article_show0" class="cb-disable <?php if($news[url] == 0): ?>selected<?php endif; ?>">澳洲新闻</label>
                        <input id="article_show1" name="url" value="http://v.juhe.cn/toutiao/index" type="radio" <?php if($news[url] == 1): ?> checked="checked"<?php endif; ?>>
                        <input id="article_show0" name="url" value="http://app.jinriaozhou.com/news-au" type="radio" <?php if($news[url] == 0): ?> checked="checked"<?php endif; ?>>
                    </div>
                    <p class="notic">如不选择，默认为澳洲新闻</p>
                </dd>
            </dl>
            <dl class="row" data-name="news_title" style="display: none;">
                <dt class="tit">
                    <label for="ac_name"><em>*</em>新闻类别</label>
                </dt>
                <dd class="opt">
                    <div class="onoff">
                      <select class="form-control"  style="width:140px"  tabindex="1" name="type">
        ...
        <div class="bot"><a href="JavaScript:void(0);" onClick="$('.form-horizontal').submit();" class="ncap-btn-big ncap-btn-green" id="submitBtn">确认获取</a></div>
    </div>   
  </form>
</div>
<script>
