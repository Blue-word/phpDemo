<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view/life\cityFriends.html";i:1500433419;s:43:"./application/admin/view/public\layout.html";i:1499577477;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <table cellspacing="0" cellpadding="0">
          <thead>
            <tr>
              ...
              <th align="center">
                <div style="text-align: center; width: 120px;">名字</div>
              </th>
              <th align="center">
                <div style="text-align: center; width: 60px;">学历</div>
              </th>
              <th align="center">
                <div style="text-align: center; width: 60px;">职业</div>
              </th>
              <th align="center">
          ...
          <tbody>
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
              <tr>
                ...
                <td align="center">
                  <div style="text-align: center; width: 60px;"><?php echo $vo['job']; ?></div>
                </td>
                <td align="center">
                  <?php if($vo['type'] == '求职'): ?>
