<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:46:"./application/admin/view/uploadify\upload.html";i:1499403521;}*/ ?>
...
<script src="__PUBLIC__/static/uploadify/jquery.min.js" type="text/javascript"></script> 
<!--防止客户端缓存文件，造成uploadify.js不更新，而引起的“喔唷，崩溃啦”-->
<script>document.write("<script type='text/javascript' "+ "src='__PUBLIC__/static/uploadify/jquery.uploadify.js?" + new Date()+ "'></s" + "cript>");
</script>			
<script src="__PUBLIC__/static/uploadify/uploadify-move.js" type="text/javascript"></script> 
...
$(function() {
	$('#uploadify').uploadify({
			...
			'buttonImage'     : '__PUBLIC__/static/uploadify/select.png',
			'queueID'         : 'fileQueue',
...
function SetImgContent(data){	
	...
	if(obj.state == 'SUCCESS'){
		var sLi = "";
		obj.newurl = '/jraz' + obj.url;
		//alert(obj.newurl);
		sLi += '<li class="img">';
		sLi += '<img src="' + obj.newurl + '" width="100" height="100" onerror="this.src=\'__PUBLIC__/static/uploadify/nopic.png\'">';
