<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:41:"./application/admin/view/index\index.html";i:1500864809;s:44:"./application/admin/view/public\menubox.html";i:1495191402;s:41:"./application/admin/view/public\left.html";i:1497497324;}*/ ?>
<!doctype html>
<html>
<head>
...
var SITEURL = window.location.host +'/jraz/index.php/admin';
</script>
...
<script type="text/javascript" src="__PUBLIC__/static/js/upgrade.js"></script>
...
<div class="admincp-header">
  ...
  <div class="admincp-name" onClick="javascript:openItem('welcome|Index');">
    <h2 style="cursor:pointer;">小蚂蚁<br>平台系统管理中心</h2>
    <!-- <img src="__PUBLIC__/static/images/admint.png" alt=""> -->
  </div>
  <div class="nc-module-menu">
    <ul class="nc-row">
      <li data-param="system"><a href="javascript:void(0);" onClick="javascript:openItem('index|System');">系统</a></li>
      <li data-param="shop"><a href="javascript:void(0);">论坛</a></li>
      <li data-param="mobile"><a href="javascript:void(0);">个人中心</a></li>
  ...
  <div class="admincp-header-r">
    <div class="manager">    
      <dl>
        <dt class="name">小蚂蚁首测版</dt>
        <dd class="group">ThinkPHP5 &nbsp 测试版</dd>
      </dl>    
      <dl>
        <dt class="name">blue</dt>
    ...
    <ul class="operate nc-row">
      ...
      <li><a class="login-out show-option" href="<?php echo U('admin/Admin/logout'); ?>" title="安全退出管理中心">&nbsp;</a></li>
    </ul>
  </div>
  <div class="clear"></div>
</div>
...
<div class="admincp-container-left">
    ...
    <?php endforeach; endif; else: echo "" ;endif; ?> 
    <div class="about" title="关于系统" onclick="ajax_form('about', '', 'http://www.xcteam.com/', 640);"><i class="fa fa-copyright"></i><span>xcteam.com</span></div>
</div>
